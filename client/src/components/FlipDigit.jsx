...
export function FlipDigit({
  ...
  return (
    <div className="flex flex-col items-center select-none">
      ...
      <div 
        className={`relative w-12 sm:w-20 md:w-24 h-16 sm:h-24 md:h-28 bg-[#101012] border border-black/80 sm:border-2 rounded-xl shadow-xl sm:shadow-2xl overflow-hidden ${borderAccentClass}`}
